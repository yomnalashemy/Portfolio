...
export const gridItems = [
  ...
  {
    id: 2,
    title: "I adapt easily to changing priorities and diverse teams across time zones.",
    description: "",
  ...
  {
    id: 3,
    title: "My tech toolbox includes MERN Stack, Python, PHP, and cybersecurity tools.",
...
export const projects = [
  {
    id: 1,
    title: "CarePulse – Patient Monitoring System",
    des: "A healthcare-focused system designed to track patient data securely and efficiently using modern full-stack technologies.",
    img: "/Carepulse.png",
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/three.svg", "/fm.svg"],
    link: "https://care-pulse-umber-tau.vercel.app/",
  },
  {
    id: 2,
    title: "Flutter Healthcare App",
    des: "Developed a mobile application using Flutter to support medical diagnostics and deliver personalized health insights.",
    img: "/Lupira.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/stream.svg", "/c.svg"],
    link: "https://github.com/yomnalashemy/Bismallah_GradProject",
  },
  {
    id: 3,
    title: "Horizon Banking",
    des: "Full Stack Comprehensive financial management platform. Secure, intuitive, and designed for your financial success.",
    img: "/horizon.png",
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/three.svg", "/c.svg"],
    link: "https://banking-bay-eta.vercel.app/",
  },
  {
    id: 4,
